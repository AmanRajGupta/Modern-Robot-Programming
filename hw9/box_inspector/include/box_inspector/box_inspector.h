...
//ADDED THE BELOW FUNCTIONS
  bool get_new_snapshot_from_box_cam_2();
  bool get_filtered_snapshots_from_box_cam_2(osrf_gear::LogicalCameraImage &filtered_box_camera_image);
  bool update_inspection_2(vector<osrf_gear::Model> desired_models_wrt_world,
        vector<osrf_gear::Model> &satisfied_models_wrt_world,
        vector<osrf_gear::Model> &misplaced_models_actual_coords_wrt_world,
        vector<osrf_gear::Model> &misplaced_models_desired_coords_wrt_world,
        vector<osrf_gear::Model> &missing_models_wrt_world,
        ...
        vector<int> &part_indices_misplaced,
        vector<int> &part_indices_precisely_placed);
  bool get_box_pose_wrt_world_2(geometry_msgs::PoseStamped &box_pose_wrt_world);
...
//added the below variables and functions
    bool got_new_snapshot_2_;
    osrf_gear::LogicalCameraImage box_inspector_image_2_;
